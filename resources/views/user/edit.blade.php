<x-app>
    ...
    <div class="card shadow p-3">
        <form method="POST" action="{{ route('user.update', $user) }}" data-parsley-validate class="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select select2-default @error('role') is-invalid @enderror" name="role" id="role" required>
